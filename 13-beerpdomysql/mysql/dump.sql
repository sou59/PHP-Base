...
--
-- Table structure for table `beer_note`
--

DROP TABLE IF EXISTS `beer_note`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `beer_note` (
  `note_id` int(11) NOT NULL,
  `beer_id` int(11) NOT NULL,
  PRIMARY KEY (`note_id`,`beer_id`),
  KEY `fk_note_has_beer_beer1_idx` (`beer_id`),
  KEY `fk_note_has_beer_note1_idx` (`note_id`),
  CONSTRAINT `fk_note_has_beer_beer1` FOREIGN KEY (`beer_id`) REFERENCES `beer` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_note_has_beer_note1` FOREIGN KEY (`note_id`) REFERENCES `note` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `beer_note`
--

LOCK TABLES `beer_note` WRITE;
/*!40000 ALTER TABLE `beer_note` DISABLE KEYS */;
/*!40000 ALTER TABLE `beer_note` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `brand` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_brand_brewery1_idx` (`brewery_id`),
  CONSTRAINT `fk_brand_brewery1` FOREIGN KEY (`brewery_id`) REFERENCES `brewery` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-05-31 10:16:42
